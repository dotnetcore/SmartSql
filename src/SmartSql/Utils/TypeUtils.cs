...
namespace SmartSql.Utils
{
    public static class TypeUtils
    {
        ...
        public static readonly MethodInfo IsDBNullMethod = DataRecordType.GetMethod("IsDBNull");
        public static readonly MethodInfo GetValueMethod_DataRecord = DataRecordType.GetMethod("GetValue");
        ...
        public static readonly MethodInfo GetValueMethod_TypeHandler = TypeHandlerType.GetMethod("GetValue", new Type[] { DataReaderType, IntType, TypeType });
