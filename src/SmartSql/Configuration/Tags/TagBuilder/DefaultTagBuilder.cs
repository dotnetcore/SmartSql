...
namespace SmartSql.Configuration.Tags.TagBuilder
{
    ...
    {
        public IEnumerable<string> NodeNames => new String[] { "#text", "#cdata-section", "Include", "IsEmpty", "IsEqual", "IsGreaterEqual", "IsGreaterThan", "IsLessEqual", "IsLessThan", "IsNotEmpty", "IsNotEqual", "IsNotNull", "IsNull", "IsTrue", "IsFalse", "IsProperty", "Placeholder", "Switch", "Case", "Default", "Dynamic", "Where", "Set", "For", "Env", "#comment" };
