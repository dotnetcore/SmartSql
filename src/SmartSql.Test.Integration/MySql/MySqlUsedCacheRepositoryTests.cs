...
public class MySqlUsedCacheRepositoryTests : IntegrationTestBase
{
    private readonly IUsedCacheRepository _usedCacheRepository;

    public MySqlUsedCacheRepositoryTests(MySqlFixture fixture) : base(fixture)
    {
        _usedCacheRepository = fixture.RepositoryFactory.CreateInstance(typeof(IUsedCacheRepository), SqlMapper)
